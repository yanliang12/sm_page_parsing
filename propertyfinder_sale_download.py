#######propertyfinder_sale_download.py#######
'''
...
bash propertyfinder_sale_download.sh &


####propertyfinder_sale_download.sh####
while true; do
   python3 propertyfinder_sale_download.py &
   sleep $[60 * 120]
done
####propertyfinder_sale_download.sh####
...
today_folder_page_html = '/dcd_data/propertyfinder/sale_page_html/source=%s'%(today)
today_folder_page_list_html = '/dcd_data/propertyfinder/sale_page_list_html/source=%s'%(today)
...
for i in range(1,11):
	list_page_url = 'https://www.propertyfinder.ae/en/search?c=1&l=6&ob=nd&page={}'.format(i)
...
parsing_from_list_to_url = udf(
	propertyfinder_parsing.parsing_from_sale_list_to_url,
