###########dubizzle_property_sale_download.py#############
'''
...
####dubizzle_property_sale_download.sh####
while true; do
   python3 dubizzle_property_sale_download.py
   sleep $[60 * 60]
done
####dubizzle_property_sale_download.sh####
...
for i in range(0,10):
	page_list_url = 'https://abudhabi.dubizzle.com/en/property-for-sale/residential/?page={}'.format(i)
...
today_folder_property_page = '/dcd_data/dubizzle/property_sale_page/source=%s'%(today)
today_folder_property_list_page = '/dcd_data/dubizzle/property_sale_list_page/source=%s'%(today)
...
yan_web_page_batch_download.args.curl_file = '/dcd_data/dubizzle_property_sale.sh'
...
yan_web_page_batch_download.args.curl_file = '/dcd_data/dubizzle_property_sale_page.sh'
yan_web_page_batch_download.args.sleep_second_per_page = '10'
yan_web_page_batch_download.args.page_regex = 'doctype'
